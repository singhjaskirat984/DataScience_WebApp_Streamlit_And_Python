...
def load_data(nrows):
	...
	data.rename(columns={'number of cyclist injured' : 'injured_cyclist'},inplace=True)
	data.rename(columns={'number of motorist injured' : 'injured_motorist'},inplace=True)
